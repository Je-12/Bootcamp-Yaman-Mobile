...
public class GravaçãoAudioPage {
  ...
  public void sampleTest() {
    (new TouchAction(driver)).tap(PointOption.point(443, 438)).perform();
    (new TouchAction(driver)).press(PointOption.point(1009, 1956)).moveTo(PointOption.point(983, 1640)).release().perform();
    (new TouchAction(driver)).tap(PointOption.point(993, 1966)).perform();
  }
