...
public class EmojiPage {
  ...
  public void sampleTest() {
    (new TouchAction(driver)).tap(PointOption.point(503, 419)).perform();
    (new TouchAction(driver)).tap(PointOption.point(54, 1943)).perform();
    (new TouchAction(driver)).tap(PointOption.point(49, 1425)).perform();
    (new TouchAction(driver)).tap(PointOption.point(301, 1410)).perform();
    (new TouchAction(driver)).tap(PointOption.point(996, 1203)).perform();
  }
