package bootcamptrios.Pages.MensagemFavorita;
...
public class MensagemFavoritaPage {
  ...
  public void sampleTest() {
    (new TouchAction(driver)).tap(PointOption.point(414, 424)).perform();
    (new TouchAction(driver)).tap(PointOption.point(483, 1361)).perform();
    (new TouchAction(driver)).tap(PointOption.point(794, 133)).perform();
  }
