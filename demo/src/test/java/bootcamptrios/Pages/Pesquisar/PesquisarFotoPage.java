package bootcamptrios.Pages.Pesquisar;
...
public class PesquisarFotoPage {
  ...
  public void sampleTest() {
    (new TouchAction(driver)).tap(PointOption.point(912, 128)).perform();
     (new TouchAction(driver)).tap(PointOption.point(222, 301)).perform();
  }
