package bootcamptrios.Pages.WhatsWEB;
...
public class WhatsWebPage {
    ...
    (new TouchAction(driver)).tap(PointOption.point(1021, 133)).perform();
    (new TouchAction(driver)).tap(PointOption.point(764, 380)).perform();
    (new TouchAction(driver)).tap(PointOption.point(493, 779)).perform();
  }
